...
namespace WindowsFormsApplication2
{
    ...
    public class ItemList : List<ItemBase>
    {
        ...
        //将对像插入列表
        public new void Add(ItemBase itemBase)
        {
        ...
        /// <returns></returns>
        public ItemBase GetSelectItem(int index)
        {
            int i = -1;
            foreach (ItemBase o in this)
            {
                if (o.Selected)
                {
                    i++;

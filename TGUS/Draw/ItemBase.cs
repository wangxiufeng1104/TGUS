...
namespace WindowsFormsApplication2
{
    ...
    public abstract class ItemBase : ICloneable
    {
        ...
        /// 从datasource中哪一列中取值
        /// </summary>
        [Description("从DataTable中哪个Columns中取值")]
        ...
        {
            using (Stream fs = Assembly.GetAssembly(typeof(ItemBase)).GetManifestResourceStream("Controls.Resources." + imageName))
            {
